<section
	class=" py-20 mx-auto flex items-center justify-center lg:py-[120px] overflow-hidden relative z-10"
>
	<div class="container">
		<div class="flex flex-wrap lg:justify-between -mx-4">
					...
					<div class="flex mb-8 max-w-[370px] w-full">
                      ...
                      "
						...
						<div class="w-full">
							...
							<p class="text-base text-body-color">(+47) 476 41 773</p>
						</div>
					</div>
					<div class="flex mb-8 max-w-[370px] w-full">
						<div
			...
			<div class="w-full lg:w-1/2 xl:w-5/12 px-4">
				<div class=" relative rounded-lg p-8 sm:p-12 shadow-lg">
					<form action="mailto:mathiasodlund@proton.me">
						<div class="mb-6">
							<input
								type="text"
								name="name"
